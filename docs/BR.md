...
5. The Public Key corresponds to an industry-demonstrated weak Private Key. For requests submitted on or after December 1, 2023, at least the following precautions SHALL be implemented:
